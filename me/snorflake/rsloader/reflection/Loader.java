package me.snorflake.rsloader.reflection;
...
public class Loader {
    ...
    public static void loadCache(){
        Variables.runtimeClassHooks.clear();
        Variables.staticFieldHooks.clear();
        try{
            ...
            for(int i=0;i<classes.getLength();++i){
                ...
                ClassNode cg = Variables.clientClasses.get(currClass.getAttributes().getNamedItem("classname").getNodeValue());
                if(cg==null){
                ...
                Variables.runtimeClassHooks.put(currClassHook.getRefactoredName(), currClassHook);
            }
